...
from ..database.speaker_models import get_speaker_db_service, SpeakerVoiceModel
...
class SpeakerNameSuggester:
    ...
    def _compile_patterns(self):
        ...
        self.patterns = {
            ...
            'question_asker': re.compile(
                r'\b(?:I have a question|can I ask|quick question)',
                re.IGNORECASE
            ),
    ...
    def _load_common_names(self):
        ...
        self.common_first_names = {
            ...
            'neutral': [
                ...
                'Sage', 'River', 'Phoenix', 'Rowan', 'Skyler', 'Cameron', 'Drew'
            ]
        }
        
        # Professional titles and roles
        self.professional_roles = {
            'leadership': ['CEO', 'CTO', 'CFO', 'President', 'VP', 'Director', 'Manager'],
    ...
    def _extract_direct_names(self, text: str) -> List[Tuple[str, float]]:
        ...
        for pattern_name, pattern in self.patterns.items():
            if 'intro' in pattern_name or 'thanks' in pattern_name or 'addressing' in pattern_name:
    ...
    def _suggest_from_behavior(self, all_text: str, segments: List[str]) -> List[Tuple[str, float]]:
        ...
        formal_count = sum(1 for indicator in formal_indicators if indicator in all_text.lower())
        informal_count = sum(1 for indicator in informal_indicators if indicator in all_text.lower())
    ...
    def _is_valid_name(self, name: str) -> bool:
        ...
        if re.match(r'^[A-Z][a-z]+(?:\s+[A-Z][a-z]+)*$', name):
            ...
            false_positives = [
                'Thank You', 'Good Morning', 'Next Steps', 'Moving Forward',
                'Let Me', 'Right Now', 'Last Week', 'Next Time'
            ]
    ...
    def _deduplicate_suggestions(self, suggestions: List[Tuple[str, float]]) -> List[Tuple[str, float]]:
    ...
    def analyze_speaker_consistency(self, folder_path: Path) -> Dict[str, Any]:
        ...
        try:
            ...
            assignments = []
            for audio_file in folder_path.glob("*.mp3"):  # Add more extensions as needed
    ...
    def validate_speaker_assignment(self, speaker_name: str, context_text: str) -> Tuple[bool, float]:
        """
...
class SpeakerContextAnalyzer:
    ...
    def analyze_speaker_interactions(self, segments: List[Dict[str, Any]]) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            return {
                ...
                'dominant_speaker': max(speaker_stats.keys(), key=lambda x: speaker_stats[x]['total_time']),
    ...
    def _find_most_interactive_speakers(self, interactions: Dict[str, int]) -> List[str]:
        ...
        for interaction, count in interactions.items():
            ...
            for speaker in speakers:
                speaker_interaction_counts[speaker] = speaker_interaction_counts.get(speaker, 0) + count
