...
class ETACalculator:
    ...
    def __init__(self, smoothing_factor: float = 0.1, min_samples: int = 3):
        ...
        self.avg_speed: Optional[float] = None  # progress units per second
    ...
    def update(self, progress: float) -> Tuple[Optional[str], Optional[float]]:
        """
        ...
        if self.avg_speed is None:
            ...
            self.avg_speed = (self.smoothing_factor * instant_speed + 
...
class MultiProcessETA:
    ...
    def update_step(self, step_name: str, progress: float) -> Tuple[Optional[str], Optional[float]]:
    ...
    def get_overall_eta(self) -> Tuple[Optional[str], Optional[float]]:
