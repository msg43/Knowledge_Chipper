...
def get_default_paths() -> Dict[str, str]:
    ...
    for directory in [output_dir, input_dir, transcripts_dir, summaries_dir, mocs_dir, 
                     exports_dir, thumbnails_dir, models_dir]:
...
def migrate_legacy_data(legacy_project_dir: Path) -> bool:
    ...
    try:
        ...
        migrations = [
            # Database
            (legacy_project_dir / "knowledge_system.db", app_support / "knowledge_system.db"),
