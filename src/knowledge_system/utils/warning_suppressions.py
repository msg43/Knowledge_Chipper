...
def suppress_ml_library_warnings() -> None:
    ...
    warnings.filterwarnings("ignore", message=".*AudioMetaData has been deprecated.*", category=UserWarning)
    warnings.filterwarnings("ignore", message=".*info has been deprecated.*", category=UserWarning)
    
    # Additional PyTorch warnings that may appear
    warnings.filterwarnings("ignore", message=".*backend is deprecated.*", category=UserWarning)
    warnings.filterwarnings("ignore", message=".*correction should be strictly less.*", category=UserWarning)
