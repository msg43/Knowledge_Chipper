...
class CancellationToken:
    ...
    def __init__(self):
        ...
        logger.debug(f"CancellationToken created - cancelled: {self.is_cancelled()}, paused: {self.is_paused()}")
    ...
    def is_cancelled(self) -> bool:
        ...
        if result:
            logger.debug(f"CancellationToken.is_cancelled() returning True, reason: {self._reason}")
        return result
