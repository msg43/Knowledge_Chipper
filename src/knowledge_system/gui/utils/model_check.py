...
def check_model_before_use(feature: str, model_type: str = "whisper") -> Tuple[bool, Optional[str]]:
    """
...
def ensure_models_ready(main_window, feature: str, required_models: list) -> bool:
    ...
    try:
        ...
        if missing:
            ...
            if missing_dict and hasattr(main_window, '_start_background_model_download'):
