...
class GUISettingsManager:
    ...
    def get_output_directory(self, tab_name: str, default: Optional[str] = None) -> str:
    ...
    def set_output_directory(self, tab_name: str, directory: Union[str, Path]) -> None:
        ...
        self.session_manager.set_tab_setting(tab_name, 'output_directory', str(directory))
    
    def get_checkbox_state(self, tab_name: str, checkbox_name: str, default: bool = False) -> bool:
        """Get the saved state of a checkbox."""
        return self.session_manager.get_tab_setting(tab_name, checkbox_name, default)
    
    def set_checkbox_state(self, tab_name: str, checkbox_name: str, state: bool) -> None:
    ...
    def set_combo_selection(self, tab_name: str, combo_name: str, selection: str) -> None:
        """Save the selection of a combo box."""
        self.session_manager.set_tab_setting(tab_name, combo_name, selection)
    
    def get_spinbox_value(self, tab_name: str, spinbox_name: str, default: int = 0) -> int:
    ...
    def get_line_edit_text(self, tab_name: str, line_edit_name: str, default: str = "") -> str:
    ...
    def add_recent_file(self, tab_name: str, file_path: Union[str, Path], max_files: int = 10) -> None:
...
_gui_settings_manager: Optional[GUISettingsManager] = None
