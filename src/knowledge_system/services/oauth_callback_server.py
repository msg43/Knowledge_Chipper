...
class OAuthCallbackHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self) -> None:
        ...
        try:
            ...
            # Extract tokens from query parameters (SkipThePodcast format)
            ...
            if access_token and user_id:
                # Success - store tokens (SkipThePodcast format)
...
class OAuthCallbackServer:
    ...
    def wait_for_callback(self, timeout: float = 300.0) -> dict[str, str] | None:
        """
...
def start_oauth_callback_server(timeout: float = 300.0) -> dict[str, str] | None:
    """
