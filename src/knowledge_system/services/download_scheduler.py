...
class DownloadScheduler:
    ...
    def calculate_delay(self, queue_size: int | None = None, target_queue_size: int = 10) -> float:
        """
    ...
    async def download_batch_with_pacing(
        ...
        for idx, url in enumerate(urls, 1):
            ...
            if idx < len(urls):
                ...
                current_queue_size = queue_size_callback() if queue_size_callback else None
