...
class PodcastRSSDownloader:
    ...
    def download_from_rss(
        ...
        for episode in episodes:
            for youtube_source_id, youtube_url in target_source_ids.items():
                if self._match_episode_to_youtube(episode, youtube_source_id, youtube_url):
        ...
        logger.info(f"Successfully downloaded {len(downloaded_files)} episodes from RSS feed")
    ...
    def _download_episode(
        ...
        try:
            ...
            self._store_source_metadata(podcast_source_id, episode, audio_file, feed_url)
