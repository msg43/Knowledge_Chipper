...
class GetReceiptsAuth:
    ...
    def authenticate(self) -> Dict[str, Any]:
        ...
        oauth_url = f"{self.base_url}/api/auth/signin"
        
        # Build OAuth URL with Knowledge_Chipper parameters
        full_oauth_url = f"{oauth_url}?redirect_to=knowledge_chipper&return_url={callback_url}"
            ...
            def do_GET(self):
                ...
                if parsed_url.path == '/auth/callback':
                    ...
                    if 'access_token' in query_params:
                        ...
                        # Error case
                        error_msg = query_params.get('error_description', query_params.get('error', ['Unknown error']))[0]
