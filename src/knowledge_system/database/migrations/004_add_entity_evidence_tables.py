...
def upgrade(db_service):
    ...
    try:
        ...
        cursor.execute("CREATE INDEX IF NOT EXISTS idx_person_evidence_claim ON person_evidence(claim_id)")
        cursor.execute("CREATE INDEX IF NOT EXISTS idx_person_evidence_time ON person_evidence(start_time)")
        cursor.execute("CREATE INDEX IF NOT EXISTS idx_concept_evidence_claim ON concept_evidence(claim_id)")
        cursor.execute("CREATE INDEX IF NOT EXISTS idx_concept_evidence_time ON concept_evidence(start_time)")
        cursor.execute("CREATE INDEX IF NOT EXISTS idx_jargon_evidence_claim ON jargon_evidence(claim_id)")
        cursor.execute("CREATE INDEX IF NOT EXISTS idx_jargon_evidence_time ON jargon_evidence(start_time)")
