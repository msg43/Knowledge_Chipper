...
"""
    ...
    print("⚠️  Remember to replace 'your_token_here' with your actual HuggingFace token!")
...
def main():
    ...
    if has_token:
        ...
        print("\n" + "="*60)
        response = input("Create minimal settings.yaml with token placeholder? (y/n): ").lower()
