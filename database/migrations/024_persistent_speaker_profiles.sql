...
-- Note: This migration creates the schema for persistent speaker profiles.
-- The fingerprint_embedding column stores a JSON object with the structure:
-- {
--   "mfcc": [...],           -- 52 floats (13 MFCCs x 4 statistics)
--   "spectral": [...],       -- 6 floats
--   "prosodic": [...],       -- 5 floats
--   "wav2vec2": [...],       -- 768 floats (if available)
--   "ecapa": [...],          -- 192 floats (if available)
--   "sample_rate": 16000,
--   "feature_version": "1.0"
-- }
--
-- Profiles are accumulated across episodes using weighted averaging:
-- new_profile = (old_profile * old_weight + new_fingerprint * 1.0) / (old_weight + 1.0)
-- This gives more weight to profiles with more samples while still incorporating new data.
