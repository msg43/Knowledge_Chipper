...
from getreceipts_config import get_config, print_config, set_production, validate_config
        ...
        "claims": [
            {
                ...
                "structured_categories_json": json.dumps(
                    ["climate science", "environmental policy", "greenhouse gases"]
                ),
            }
        ],
        "evidence_spans": [
...
def upload_to_getreceipts(
    session_data: dict[str, Any], use_production: bool = False
) -> dict[str, Any]:
    """
