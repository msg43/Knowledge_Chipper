...
def test_auto_update_config():
    ...
    try:
        ...
        if config_file.exists():
            ...
            with open(config_file) as f:
                ...
                if "auto_check_updates" in content:
                    ...
                    print(
                        "ℹ️  auto_check_updates not yet in config file (will be added on first change)"
                    )
        else:
        ...
        print(
            f"✅ Changed auto_check_updates: {original_value} → {settings.app.auto_check_updates}"
        )
        ...
        try:
            ...
            with open(config_file) as f:
                content = f.read()
                if (
                    f"auto_check_updates: {settings.app.auto_check_updates}".lower()
                    in content.lower()
                ):
...
def test_state_integration():
    ...
    try:
        ...
        print(
            f"✅ Default auto_check_updates in preferences: {prefs.auto_check_updates}"
        )
        ...
        print(
            f"✅ Modified preferences: auto_check_updates={prefs.auto_check_updates}, last_update_check={prefs.last_update_check}"
        )
