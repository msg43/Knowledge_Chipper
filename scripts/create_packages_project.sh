#!/bin/bash
# create_packages_project.sh - Create a proper Packages project file with expanded paths
...
# Create the project file with actual paths
cat > "$BUILD_DIR/SkipThePodcast.pkgproj" << EOF
...
echo "Created Packages project file: $BUILD_DIR/SkipThePodcast.pkgproj"
