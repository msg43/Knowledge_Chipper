...
def main():
    ...
    if all_files_present and found_files >= total_files * 0.8:  # Allow for 80% coverage
        ...
        if found_files < total_files * 0.5:
            ...
            print(
                "Some test files are missing, but you may be able to run limited tests."
            )
        return False
