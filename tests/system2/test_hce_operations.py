...
from src.knowledge_system.database.hce_models import Claim, Concept, Episode, Jargon, Person
...
class TestStoreMininingResults:
    ...
    def test_store_mining_results_creates_episode(self, test_db_service, sample_miner_output):
    ...
    def test_store_mining_results_stores_claims(self, test_db_service, sample_miner_output):
    ...
    def test_store_mining_results_stores_jargon(self, test_db_service, sample_miner_output):
    ...
    def test_store_mining_results_stores_people(self, test_db_service, sample_miner_output):
    ...
    def test_store_mining_results_stores_concepts(self, test_db_service, sample_miner_output):
    ...
    def test_store_mining_results_multiple_outputs(self, test_db_service):
        ...
        output1 = UnifiedMinerOutput({
            "claims": [{"claim_id": "c1", "claim_text": "Claim 1", "claim_type": "factual"}],
            "jargon": [],
            "people": [],
            "mental_models": []
        })
        ...
        output2 = UnifiedMinerOutput({
            "claims": [{"claim_id": "c2", "claim_text": "Claim 2", "claim_type": "causal"}],
            "jargon": [],
            "people": [],
            "mental_models": []
        })
    ...
    def test_store_mining_results_handles_duplicates(self, test_db_service, sample_miner_output):
