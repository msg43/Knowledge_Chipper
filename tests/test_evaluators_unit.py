...
def test_imports():
    ...
    try:
        from knowledge_system.processors.hce.evaluators.jargon_evaluator import evaluate_jargon
        from knowledge_system.processors.hce.evaluators.people_evaluator import evaluate_people
        from knowledge_system.processors.hce.evaluators.concepts_evaluator import evaluate_concepts
...
def test_pipeline_integration():
    ...
    try:
        ...
        from knowledge_system.processors.hce.config_flex import PipelineConfigFlex, StageModelConfig
        ...
        print(f"✅ Pipeline instantiated with miner_selectivity={config.miner_selectivity}")
        
        # Check that pipeline has the parallel evaluation method
        assert hasattr(pipeline, '_evaluate_all_entities_parallel'), "Pipeline missing _evaluate_all_entities_parallel"
...
def test_database_bulk_insert():
    ...
    try:
        ...
        # Check method exists
        assert hasattr(DatabaseService, 'bulk_insert_json'), "DatabaseService missing bulk_insert_json"
