...
from knowledge_system.utils.ipc_communication import ProcessCommunicationManager, IPCCommunicator
...
class TestProcessIsolation(ProcessIsolationTestCase):
    ...
    def test_ipc_communication(self):
        ...
        progress_received.assert_called_once_with(1, 3, "Processing file 1", 50, "transcription")
...
class TestErrorHandling(ProcessIsolationTestCase):
    ...
    def test_graceful_shutdown(self):
        ...
        with patch.object(worker, 'state') as mock_state, \
...
class TestCrashRecovery(ProcessIsolationTestCase):
    ...
    def test_checkpoint_detection(self):
        ...
        from knowledge_system.gui.dialogs.crash_recovery_dialog import CrashRecoveryDialog
