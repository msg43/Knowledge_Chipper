...
def test_boundary_respects_hotspots_and_sentences():
    ...
    paras = [
        ...
        Paragraph(text="Gamma is here and continues. Delta ends.", span_start=22, span_end=62),
        Paragraph(text="Hotspot should not be split. Keep together.", span_start=63, span_end=106),
    ]
    hotspots = [[1, 2]]
