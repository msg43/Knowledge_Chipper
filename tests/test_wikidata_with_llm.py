        ...
        for cat in categories:
            ...
            if cat['alternatives']:
                ...
                for alt in cat['alternatives'][:2]:
                    print(f"        - {alt['category_name']} ({alt['embedding_similarity']:.3f})")
            print()
...
def test_claim_categorization_with_llm():
    ...
    try:
        ...
        test_claims = [
            ...
            ("Taiwan semiconductor supply chain faces geopolitical risks", ["Finance", "Technology"]),
...
def test_performance_monitoring():
    ...
    try:
        ...
        print(f"   Latency:")
        print(f"     Stage 1 (LLM) median: {report['latency']['stage1_median_ms']:.0f}ms")
        print(f"     Stage 2 (Embedding) median: {report['latency']['stage2_median_ms']:.1f}ms")
