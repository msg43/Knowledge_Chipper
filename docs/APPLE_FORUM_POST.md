# Apple Developer Forums Post - Notarization Issue

**Status:** DRAFT - Test notarization first before posting!
...
**Title:** Notarization Rejects Valid Developer ID Certificates - Apple Infrastructure Issue?

**Subtopic:** Developer Tools & Services > Code Signing  
**Tags:** #notarization #code-signing #developer-id

### Environment
- **macOS:** 15.6.1 (update if changed)
- **Xcode:** 26.0.1 (update if changed)
...
1. Go to https://developer.apple.com/forums/
2. Click "Post" button
3. Select Topic: **Developer Tools & Services**
4. Select Subtopic: **Code Signing**
5. Add Tags: `notarization`, `code-signing`, `developer-id`
6. Copy the post content above (from "Environment" to the end)
7. Update any changed system information
8. **Add a NEW failed submission ID** from your December test (see TEST_BEFORE_POSTING.md)



## References

- [Quinn's Top Ten DevForums Tips](https://developer.apple.com/forums/thread/706527)
- [Similar Issue Thread](https://developer.apple.com/forums/thread/784184)
- Apple Developer Support Case: 102789234714
