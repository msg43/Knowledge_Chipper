...
echo ""
echo "🚀 Launching NEW Layer Cake GUI..."
echo ""
echo "Features:"
echo "  ⚙️  Settings at top for first-time setup"
echo "  🎵  Drag & drop files onto tiles"
echo "  🎨  8 color presets + custom colors"
echo "  📊  Live status boxes on right pane"
echo ""

# Activate virtual environment and launch Layer Cake GUI
source venv/bin/activate
python -m knowledge_system.gui.layer_cake_main_window
