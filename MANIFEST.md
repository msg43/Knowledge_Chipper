...
**Last Updated:** October 30, 2025 (Model Registry Updates)
...
- `docs/SETTINGS_SINGLE_SOURCE_OF_TRUTH.md` - Complete architecture documentation for settings hierarchy, single source of truth implementation, and maintenance guidelines (October 2025)
